            ...
            {isSignedIn ? (
              ...
              <>
                <SignInButton mode="modal">
                  <button className="bg-white text-blue-600 font-bold py-3 px-8 rounded-full hover:bg-blue-50 transition-colors shadow-lg flex items-center justify-center">
                    <UserCheck className="mr-2 h-5 w-5" />
                    Get Started Free
                  </button>
                </SignInButton>
                <SignInButton mode="modal">
                  <button className="bg-transparent border-2 border-white text-white font-bold py-3 px-8 rounded-full hover:bg-white hover:text-blue-600 transition-colors flex items-center justify-center">
                    Sign In
                  </button>
                </SignInButton>
              </>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden transform transition-transform hover:scale-105">
              <div className="p-8">
                ...
                {isSignedIn ? (
                  ...
                  <SignInButton mode="modal">
                    <button className="inline-flex items-center bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-6 rounded-full transition-colors">
                      Get Started
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          {isSignedIn ? (
            ...
            <>
              ...
              <SignInButton mode="modal">
                <button className="bg-white text-blue-600 font-bold py-3 px-8 rounded-full hover:bg-blue-50 transition-colors shadow-lg inline-flex items-center">
